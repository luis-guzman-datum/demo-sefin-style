...
export class MapaSitioComponent implements OnInit {
  ...
  //opciones de filtros y paginado
  search = '';
  search2 = '';
  infoPantalla = {
    pantalla: 'lista',
  ...
  ngOnInit(): void {
    ...
    this.getIngresosPorColector();
  }

  // se crea lista de colectores
  getIngresosPorColector() {
  ...
  //metodo que simula la seleccion de un banco
  seleccionarBanco(data: any) {
    this.infoPantalla = { pantalla: 'seleccionado', selected: data };

    this.getCierreBancoComisionesDetalleData = {
      detalleComisionDetalle: [
        {
